...
def preprocess(img: torch.Tensor, target_size: int = 640) -> (torch.Tensor, int, int):
    """
    ...
    return resized / 255.0, new_h, new_w
...
def rescale_bboxes(
    ...
    scale_w = orig_shape[1] / target_shape[1]
    scale_h = orig_shape[0] / target_shape[0]
